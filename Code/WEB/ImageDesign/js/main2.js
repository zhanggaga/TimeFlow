    ...
    var Main = {
        ...
        eventAtt: function(){
            ...
            */
            ...
            this.addEvent("#open_btn", "click", function(e){
        ...
        openFile: function(fileUrl){//打开文件
		    ...
		    if(!/image\/\w+/.test(fileUrl.type)){ 
				layer.msg('格式不对  请上传图像文件 (.png/.jpg/.gif)',function(){
				});
		        return false; 
		    }  
            if(fileUrl.size>max_size) {
				layer.msg('图像过大  请上传小于7M的照片',function(){
				});
		        return false; 
		    }
         	reader.readAsDataURL(fileUrl);
            reader.onload = function(){
//			var fileSize = $("#myMage").files[0].size;
